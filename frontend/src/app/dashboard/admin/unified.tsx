...
const UnifiedAdminPageComponent: React.FC = () => {
  // State for user info
  ...
  // State for Auto Schedule AI Modal
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Panel Administrasi dengan Auto Schedule AI • {currentTime}
              </p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold text-blue-600">{currentTime}</div>
              <p className="text-sm text-gray-500">Waktu Real-time</p>
            </div>
          </div>
        </div>
      </div>
...
export default withAuth(UnifiedAdminPageComponent, ['ADMIN']);
