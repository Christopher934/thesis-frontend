        ...
        <div className="flex-1">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <div className="w-10 h-10 bg-hospitalBlueLight rounded-full flex items-center justify-center">
                <svg className="w-5 h-5 text-hospitalBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="uppercase font-medium">{formatTime(item.shift.jammulai)} - {formatTime(item.shift.jamselesai)}</span>
                </div>
