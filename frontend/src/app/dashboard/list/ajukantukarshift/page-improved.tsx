              ...
              <div className="flex items-center gap-2 mb-2">
                <h3 className="font-semibold text-gray-900">
                  {activeTab === 'my-requests' 
                    ? `Ke: ${item.toUser.namaDepan} ${item.toUser.namaBelakang}`
                    : `Dari: ${item.fromUser.namaDepan} ${item.fromUser.namaBelakang}`
                  }
                </h3>
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${STATUS_BADGE_STYLE[item.status] || 'bg-gray-100 text-gray-800'}`}>
