      ...
      <td className="p-4">
        <div className="space-y-1">
          ...
          <div className="text-xs bg-gray-100 px-2 py-1 rounded">
            {formatLokasiShift(item.shift?.lokasishift || 'N/A')}
          </div>
        </div>
      </td>
      <td className="p-4">
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4 shadow-sm">
      ...
      <div className="space-y-2 mb-3">
        ...
        <div className="flex items-center text-sm text-gray-600">
          ...
          <span>{formatLokasiShift(item.shift?.lokasishift || 'N/A')}</span>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg p-4 md:p-6 max-w-lg w-full relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <span className="flex-1 text-gray-900">{formatLokasiShift(detailItem.shift?.lokasishift || 'N/A')}</span>
              </div>
