                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900">Informasi Shift</h2>
                                <p className="text-gray-600 text-sm">Detail lokasi dan waktu kerja</p>
                            </div>
                        </div>
                                ...
                                >
                                    ...
                                    {availableShiftTypes.map(shiftType => (
                                        <option key={shiftType} value={shiftType}>
                                            {shiftType === 'PAGI' ? 'Pagi' :
                                             shiftType === 'SIANG' ? 'Siang' :
                                             shiftType === 'MALAM' ? 'Malam' :
                                             shiftType === 'ON_CALL' ? 'On Call' :
                                             shiftType === 'JAGA' ? 'Jaga' : shiftType}
                                        </option>
                                    ))}
                                </select>
                                {errors.tipeshift && (
